# Made with help from freecodecamp and Data Professor
# Data Source: CoinMarketCap

# Importing all eight libraries
...
# Divide page to 3 columns (col1 = sidebar, col2 & col3 = page contents)
col1 = st.sidebar
...
# Web scraping of CoinMarketCap data from the help of the Medium article.
@st.cache
def load_data():
